var Zepto = function() {
    ...
    var w, E, j, S, C, O, T = [], N = T.slice, P = T.filter, A = window.document, L = {}, R = {}, k = {
        "column-count": 1,
        columns: 1,
        "font-weight": 1,
        "line-height": 1,
        ...
        "z-index": 1,
        zoom: 1
    }, I = /^\s*<(\w+|!)[^>]*>/, Z = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, H = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, _ = /^(?:body|html)$/i, D = /([A-Z])/g, $ = ["val", "css", "html", "text", "data", "width", "height", "offset"], F = ["after", "prepend", "before", "append"], M = A.createElement("table"), q = A.createElement("tr"), z = {
        ...
        th: q,
        "*": A.createElement("div")
    }, J = /complete|loaded|interactive/, U = /^[\w-]*$/, B = {}, V = B.toString, Q = {}, X = A.createElement("div"), Y = {
        tabindex: "tabIndex",
        readonly: "readOnly",
        "for": "htmlFor",
        "class": "className",
    ...
    Q.fragment = function(t, e, n) {
        var r, i, a;
        return Z.test(t) && (r = j(A.createElement(RegExp.$1))),
    ...
    Q.init = function(t, n) {
        ...
        if ("string" == typeof t)
            ...
            if (W(t))
                ...
                r = Q.fragment(t.trim(), RegExp.$1, n),
                t = null;
            else {
                if (n !== w)
                    return j(n).find(t);
    ...
    j.fn = {
        ...
        closest: function(t, e) {
            var n = this[0]
              , i = !1;
            for ("object" == typeof t && (i = j(t)); n && !(i ? i.indexOf(n) >= 0 : Q.matches(n, t)); )
        ...
        css: function(e, n) {
            ...
            if ("string" == t(e))
                ...
                for (E in e)
                    e[E] || 0 === e[E] ? a += u(E) + ":" + f(E, e[E]) + ";" : this.each(function() {
                        this.style.removeProperty(u(E))
                    });
            return this.each(function() {
        ...
        offsetParent: function() {
            return this.map(function() {
                for (var t = this.offsetParent || A.body; t && !_.test(t.nodeName) && "static" == j(t).css("position"); )
                    t = t.offsetParent;
                return t
            })
        }
...
function(t) {
    ...
    var m, v, g = 0, y = window.document, b = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, x = /^(?:text|application)\/javascript/i, w = /^(?:text|application)\/xml/i, E = "application/json", j = "text/html", S = /^\s*$/, C = y.createElement("a");
    ...
    t.ajax = function(e) {
        ...
        n.href = i.url,
        n.href = n.href,
        i.crossDomain = C.protocol + "//" + C.host != n.protocol + "//" + n.host),
        ...
        "jsonp" == p)
            ...
            t.ajaxJSONP(i, c);
        var g, b = i.accepts[p], x = {}, w = function(t, e) {
            x[t.toLowerCase()] = [t, e]
        }, E = /^([\w-]+:)\/\//.test(i.url) ? RegExp.$1 : window.location.protocol, j = i.xhr(), O = j.setRequestHeader;
        if (c && c.promise(j),
        ...
        j.onreadystatechange = function() {
            if (4 == j.readyState) {
                ...
                if (j.status >= 200 && j.status < 300 || 304 == j.status || 0 == j.status && "file:" == E) {
                    ...
                    try {
                        "script" == p ? (0,
                        eval)(e) : "xml" == p ? e = j.responseXML : "json" == p && (e = S.test(e) ? null : t.parseJSON(e))
                    } catch (r) {
                        n = r
                    }
...
function(t, e) {
    ...
    "use strict";
    var e, n, r, i = {}, o = !!document.querySelector && !!t.addEventListener, a = {
        speed: 500,
    ...
    i.animateScroll = function(e, n, i) {
        ...
        var y, b, x, w = null === r ? 0 : l(r) + r.offsetTop, E = p(u, w, parseInt(o.offset, 10)), j = E - g, S = d(), C = 0;
        v(n, o.updateURL);
        var O = function(r, i, a) {
            var s = t.pageYOffset;
            (r == i || s == i || t.innerHeight + s >= S) && (clearInterval(a),
            u.focus(),
            o.callbackAfter(e, n))
        }
          , T = function() {
    ...
    var g = function(t) {
      ...
      , y = function(t) {
        n || (n = setTimeout(function() {
            n = null,
            headerHeight = null === r ? 0 : l(r) + r.offsetTop
        }, 66))
    };
    return i.destroy = function() {
        e && (document.removeEventListener("click", g, !1),
        ...
        function r(e) {
            ...
            return t.each(c, function(t, r) {
                for (var t = 0; t < s.length; t++)
                    void 0 !== r[s[t]] && r[s[t]].toLowerCase().indexOf(e.toLowerCase()) !== -1 && (n.push(r),
                    t = s.length)
            }),
            n
        }
